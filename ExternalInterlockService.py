...
class Iface(object):
    ...
    def getPlaceSearchProviderList(self, region):
        """
        Parameters:
         - region
...
class Client(Iface):
    ...
    def getPlaceSearchProviderList(self, region):
        ...
        """
        self.send_getPlaceSearchProviderList(region)
        return self.recv_getPlaceSearchProviderList()

    def send_getPlaceSearchProviderList(self, region):
        self._oprot.writeMessageBegin('getPlaceSearchProviderList', TMessageType.CALL, self._seqid)
        args = getPlaceSearchProviderList_args()
        args.region = region
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getPlaceSearchProviderList(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getPlaceSearchProviderList_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getPlaceSearchProviderList failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["getPlaceSearchProviderList"] = Processor.process_getPlaceSearchProviderList
    ...
    def process_getPlaceSearchProviderList(self, seqid, iprot, oprot):
        args = getPlaceSearchProviderList_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getPlaceSearchProviderList_result()
        try:
            result.success = self._handler.getPlaceSearchProviderList(args.region)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getPlaceSearchProviderList", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class getPlaceSearchProviderList_args(object):
    """
    Attributes:
     - region
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getPlaceSearchProviderList_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getPlaceSearchProviderList_args)
getPlaceSearchProviderList_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'region', 'UTF8', None, ),  # 1
)


class getPlaceSearchProviderList_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getPlaceSearchProviderList_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getPlaceSearchProviderList_result)
getPlaceSearchProviderList_result.thrift_spec = (
