...
class getCountryInfo_args(object):
    ...
    def write(self, oprot):
        ...
        if self.simCard is not None:
            oprot.writeFieldBegin('simCard', TType.STRUCT, 11)
...
getCountryInfo_args.thrift_spec = (
    ...
    None,  # 9
    None,  # 10
    (11, TType.STRUCT, 'simCard', [SimCard, None], None, ),  # 11
)
...
class getSettingsAttributes2_args(object):
            ...
            if fid == 2:
                if ftype == TType.SET:
                    ...
                    for _i70 in range(_size66):
                        ...
                        self.attributesToRetrieve.add(_elem71)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributesToRetrieve is not None:
            ...
            for iter72 in self.attributesToRetrieve:
...
class updateSettingsAttributes2_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i77 in range(_size73):
                        ...
                        self.attributesToUpdate.add(_elem78)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.attributesToUpdate is not None:
            ...
            for iter79 in self.attributesToUpdate:
