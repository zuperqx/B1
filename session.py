...
from akad import AuthService, TalkService, ChannelService, CallService, ShopService, PollingService

class Session:

    def Liff(self, isopen=True, proxy=None):
        self.transport = THttpClient.THttpClient(self.host, custom_proxy=proxy)
    ...
    def Poll(self, isopen=True, proxy=None):
        self.transport = THttpClient.THttpClient(self.host, custom_proxy=proxy)
        self.transport.setCustomHeaders(self.headers)
        
        self.protocol = TCompactProtocol.TCompactProtocol(self.transport)
        self._talk  = PollingService.Client(self.protocol)
